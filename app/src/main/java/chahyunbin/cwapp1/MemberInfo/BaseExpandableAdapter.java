package chahyunbin.cwapp1.MemberInfo;
...
class BaseExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent){
        ...
        if(v == null){
            ...
            viewHolder.checkBox1 = (CheckBox)v.findViewById(R.id.checkbox1);
            v.setTag(viewHolder);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent){
        ...
        if(v == null){
            ...
            viewHolder.checkBox2 = (CheckBox)v.findViewById(R.id.checkbox2);
            v.setTag(viewHolder);
        }else{
            viewHolder = (ViewHolder)v.getTag();
        }
